...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="relative flex-grow flex flex-col items-center justify-center p-4 md:p-8 overflow-hidden">
        ...
        <div className="w-full max-w-4xl mx-auto text-center z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-card/20 backdrop-blur-sm border-white/20 text-white hover:border-primary transition-colors">
                    <CardHeader>
                        <CardTitle>Suivi des Matchs</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="text-neutral-300 mb-4">Accédez aux scores, chronomètres et compositions en direct.</p>
                        <Button asChild>
                 ...
                 <Card className="bg-card/20 backdrop-blur-sm border-white/20 text-white hover:border-primary transition-colors">
                    ...
                    <CardContent>
                        <p className="text-neutral-300 mb-4">Consultez les fiches et statistiques de tous les joueurs.</p>
                         <Button asChild>
                 ...
                 <Card className="bg-card/20 backdrop-blur-sm border-white/20 text-white hover:border-primary transition-colors">
                    ...
                    <CardContent>
                        <p className="text-neutral-300 mb-4">Gérez les informations sur les équipes que vous affrontez.</p>
                         <Button asChild>
